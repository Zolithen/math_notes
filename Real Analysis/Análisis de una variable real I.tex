...
\item
	Toda sucesión acotada tiene un punto de acumulación. Además es no convergente si y solo sí es oscilante si y solo si tiene dos o más puntos de acumulación.
\end{enumerate}
\end{prop}
