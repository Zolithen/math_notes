...
\begin{define}
	TODO: Cambiar todos los dominios para que solo se requiera punto de acumulacion infinito, punto de acumulacion derecha o izquierda.
	\begin{itemize}
		\item
...
\begin{prop}
	Sea $f: A \rightarrow \reales$ y $p$ punto de acumulación de $A$. Si $f$ converge a $L_1$ y $L_2$ en $p$ entonces $L_1 = L_2$.
\end{prop}
...
\begin{ejem}
	...
	\begin{equation*}
		...
		\begin{array}{cc}
			...
			0 & \text{ en el resto de puntos }
		\end{array}\right.
	\end{equation*}
	no es continua en $[0, 1]$, pero su restricción a este intervalo si lo es.
\end{ejem}
